    ...
    <div className={`flex flex-col gap-2 ${className}`}>
      <div className="inline-flex w-full h-11 items-stretch rounded-lg border border-gray-300 overflow-hidden shadow-sm bg-white">
        <button
          ...
          className="w-11 flex items-center justify-center text-xl text-gray-700 hover:bg-gray-100 disabled:opacity-50"
          disabled={qty <= 1}
        >
          −
        </button>
        <input
          ...
          className="flex-1 min-w-0 text-center text-base font-medium outline-none focus:ring-2 focus:ring-[#660000]/40"
        ...
        <button
          ...
          className="w-11 flex items-center justify-center text-xl text-gray-700 hover:bg-gray-100"
        >
          +
        </button>
      </div>
