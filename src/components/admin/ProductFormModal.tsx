...
export default function ProductFormModal({ open, onClose, productId = null, onSaved }: ProductFormModalProps) {
  ...
  useEffect(() => {
    if (!open || !isEditMode || !productId) return;
    ...
    loadProduct();
  }, [open, isEditMode, productId, token, onClose]);
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/40 p-3 sm:p-4" onClick={onClose}>
      <div
        className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white p-5 shadow-xl sm:p-6"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="mb-5 flex items-start justify-between gap-3">
          <div>
            <h2 className="text-xl font-bold text-[#660000] sm:text-2xl">
        ...
        {loading ? (
          <div className="flex min-h-[240px] items-center justify-center">
            <div className="text-center">
              <div className="mx-auto mb-4 h-12 w-12 animate-spin rounded-full border-4 border-gray-300 border-t-[#660000]" />
